...
if (!isset($_GET['simpancatatan']))
{
	...
	echo"<form method='GET' action='ekskulsaran.php'>";
	echo"<p align='center'>";
	echo"<table border=0>";
	echo"<tr>";
	echo"<td><b>Daftar Ekskul dan Saran</b></td>"; 
	echo"</tr>";
	...
	echo"<td colspan='5'><p align='center'><b>Ekstrakurikuler</b></p></td>";
	echo"<td colspan='5'><p align='center'><b>Keterangan</b></p></td>";
	...
	echo"<td><p align='center'><b>Keterangan 5</b></p></td>";
	echo"</tr>";
	//$query1="SELECT * FROM daftar_hadir WHERE tahun_ajaran ='$datas[5]'"; $hasil1=mysql_query($query1) or die(mysql_error()); //$data1=mysql_fetch_array ($hasil1);
	$query2="SELECT * FROM ekskul_dan_saran WHERE tahun_ajaran ='$datas[5]'"; $hasil2=mysql_query($query2) or die(mysql_error()); //$data2=mysql_fetch_array ($hasil2);
	if($datas[4]!='')
	...
	{	
		...
		echo"<td><input type='text' name='keterangan1[]' value='$data2[8]'> </td>";
		echo"<td><input type='text' name='keterangan2[]' value='$data2[9]'> </td>";
		echo"<td><input type='text' name='keterangan3[]' value='$data2[10]'> </td>";
		echo"<td><input type='text' name='keterangan4[]' value='$data2[11]'> </td>";
		echo"<td><input type='text' name='keterangan5[]' value='$data2[12]'> </td>";
		
		echo"<td><input type='text' name='saran[]' value='$data2[13]'> </td>";
		echo"</tr>";
...
{	//$query1="SELECT * FROM daftar_hadir WHERE tahun_ajaran ='$datas[5]'"; $hasil1=mysql_query($query1) or die(mysql_error()); $data1=mysql_fetch_array ($hasil1);
	...
	for ($i=0; $i<$baris; $i++)
	{
		...
		$querysimpan2 = "UPDATE ekskul_dan_saran SET ekskul1 ='$ekskul1[$i]',ekskul2 ='$ekskul2[$i]',ekskul3 ='$ekskul3[$i]', ekskul4 ='$ekskul4[$i]',ekskul5 ='$ekskul5[$i]',
						keterangan1 ='$keterangan1[$i]',keterangan2 ='$keterangan2[$i]',keterangan3 ='$keterangan3[$i]',keterangan4 ='$keterangan4[$i]',keterangan5 ='$keterangan5[$i]',
						saran ='$saran[$i]'  
